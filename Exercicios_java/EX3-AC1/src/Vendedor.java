...
public class Vendedor {
    ...
    public static double calcularPagamentoComissao(double valorVenda, double desconto, double percentualComissao){
         return valorVenda * percentualComissao / 100 - desconto;
    }
